...
$string ['examgenerationinprogress'] = 'Exam generation in progress';
...
$string ['uploadexamfile'] = 'PDF or ZIP file with the digitized answers';
$string ['uploadexamfilepdf'] = 'PDF file';
$string ['uploadinganswersheets'] = 'Uploading student answer sheets';
$string ['enabledigitizedzipfile'] = 'Enable digitized zip file';
$string ['enabledigitizedzipfile_help'] = 'Enables the upload of answers in zip format produced by the emarkingdesktop utility';
$string ['usedigitizedzipfile'] = 'Use pre-processed digitized answers';
$string ['filerequiredpdf'] = 'A PDF or ZIP file with the digitized answers is required';
$string ['filerequiredpdf_help'] = 'A PDF file with the digitized answers is required. You can also use a ZIP file with the pre-processed answers if your server can not cope with the processing load.';
...
$string['previewquiz'] = 'Preview quiz as page';
$string['answersheetsquiz'] = 'Download answer sheets';
$string['quizprinting'] = 'Quiz printing';
$string['confirmcreateattempts'] = 'When creating attempts all previous attempts will be deleted. Are you sure?';
$string['createattempts'] = 'Create attempts';
$string['uploadanswers'] = 'Upload answers';
$string['finished'] = 'Finished';
$string['processing'] = 'Processing';
$string['pdfquizcreated'] = 'Your PDF quiz was created successfully, please download the file using the link below.';
$string['creatingquiz'] = 'Creating PDF for quiz';
$string['loadingquestions'] = 'Loading questions';
$string['downloadingimages'] = 'Downloading images';
$string['creatingpdffile'] = 'Creating PDF file';
$string['answersfile'] = 'Answers file';
$string['answersfile_help'] = 'The file containing the student answers';
$string['answersfileisrequired'] = 'A file with student answers is required';
$string['fileisnotcsv'] = 'Only csv files can be processed';
$string['csvdelimiter'] = 'CSV delimiter';
$string['csvdelimiter_help'] = 'The delimiter for each cell in the CSV file';
$string['finishimportcsv'] = 'Finish import';
$string['csvimportsuccessfull'] = 'CSV answers import successfull! To save the answers you must finish the import.';
$string['idnumber'] = 'ID';
// GENERAL STRINGS
...
$string ['invalidemarkingcourse'] = 'Invalid EMarkings in this course, please create at least one.';
...
$string['dayssenttoprint'] = 'Days sent to print';
$string['printeddays'] = 'Printed days';
$string['digitalizeddays'] = 'Digitalized days';
$string['daysincorrection'] = 'Days in grading';
$string['gradeddays'] = 'Gradeded days';
$string['publisheddays'] = 'Published days';
$string['daysinregrading'] = 'Days in regrading';
$string['regradeddays'] = 'Regradeded days';
